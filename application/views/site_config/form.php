<div class="breadcrumb">
		<a href="">Home</a> 
		<a href="">Site Configuration Form</a>
	</div>
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			<i class="fa fa-newspaper-o"></i>
			<div class="content-header-title">Site Configuration Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group">
							<label for=""> Site Mode</label>
							<select name="group_id" class="form-control">
								<?php foreach ($modes as $key => $mode) { ?>
									<option value="<?php echo $mode->id; ?>"><?php echo $mode->mode_name; ?></option>
								<?php } ?>
							</select>
							<div class="validation-message" data-field="mode"></div>
						</div>
					</form>
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
			url: "<?php echo base_url() . 'Site Configuration/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'Site Configuration/action'; ?>", formData).done(function(data) {
