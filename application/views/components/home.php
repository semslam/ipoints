		...
		<div class="content">
			<div class="container">
				<div class="main-text">
					...
					<a href="<?=base_url('purchase/product')?>" data-toggle="modal" data-target="#exampleModal" id="buy_ipoints">
		...
		<div class="container">
				<div class="row">
					<div class="col-md-12 copyright">
						...
						<?php } ?> <?php echo $this->config->item('company_name'); ?>. All rights reserved. <br /><br />Address: <?php echo $this->config->item('company_address'); ?>
					</div>
				</div>
			</div>
	</div>
