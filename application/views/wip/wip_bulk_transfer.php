							...
							<form id="wipTransferForm">
								<div class="row">
                                    <div class="form-group col-sm-3">
										<input title="Enter Merchant Name Or Email" type="text" placeholder="Merchant Name Or Email" name="customerName" class="form-control customerName">
           ...
           var wipTransferData =''; 
                      for(x in data){
                        wipTransferData+='<tr>'+
                                ...
                                '<td>'+data[x].status+'</td>'+
                                '<td><span class="pull-right claimed label-success">'+data[x].completed+'</span></td>'+
                                '<td><span class="pull-right claimed label-info">'+data[x].pending+'</span></td>'+
                                '<td><span class="pull-right claimed label-warning ">'+data[x].invalid+'</span></td>'+
                                '<td><span  class="pull-right claimed label-danger " >'+data[x].cancel+'</span></td>'+
