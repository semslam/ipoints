...
@-webkit-keyframes spin {
 ...
 @keyframes spin {
	...
	<!------------------------ View Stats -------------------------------------------------->
	<!-- Modal -->
	<div class="modal fade bd-example-modal-lg" id="stats" tabindex="-1" role="dialog" aria-labelledby="statsModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
	...
	function transferComplete(){
		...
		$('.balance_list').html('<div style="text-align: center;" class="complete">'+
								'<div class="auth-content">'+
										...
										'</div>'+
										'<div class="form-group">'+
											'<button class="btn btn-success" type="button" data-dismiss="modal">Continue</button>'+
										'</div>'+
								'</div>'+
						'</div>');
	}
